...
public class Exam {
	...
	public Exam(Integer id, String examSub, Integer examNum, String examHall, String examPaper, String examTeacher, String examTime, Integer examState, String examStulist) {
		this.id = id;
