...
<title>教师后台管理页面-Powered by java1234</title>
...
<div region="north" style="height: 78px;background-color: #E0ECFF">
	<table style="padding: 5px" width="100%">
		<tr>
			<td width="50%">
				<img alt="logo" width="326px" height="60px" src="${pageContext.request.contextPath}/static/images/zhaojunbo.png">
			</td>
			<td valign="bottom" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>xxxxx</font>
			</td>
		</tr>
	</table>
</div>
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px"><font color="red" size="10">欢迎使用上机考试管理系统</font></div>
		</div>
	</div>
</div>
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		<div title="首页" data-options="selected:true,iconCls:'icon-item'" style="padding: 10px">
		</div>
		<div title="考前操作"  data-options="iconCls:'icon-bkgl'" style="padding:10px;">
			<a href="javascript:openTab('考试信息管理','teacher_TypeManage.jsp','icon-bkgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-bkgl'" style="width: 150px;">考试信息管理</a>
			<a href="javascript:openTab('学生管理','teacher_StudentManage.jsp','icon-bklb')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-bklb'" style="width: 150px;">学生名单管理</a>
		</div>
		<div title="考中管理" data-options="iconCls:'icon-bklb'" style="padding:10px">
		...
		<div title="考后操作"  data-options="iconCls:'icon-plgl'" style="padding:10px">
		</div>
		<div title="个人信息管理"  data-options="iconCls:'icon-grxx'" style="padding:10px">
			<a href="javascript:openTab('修改个人信息','','icon-grxxxg')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-grxxxg'" style="width: 150px;">修改个人信息</a>
		</div>
...
<div region="south" style="height: 25px;padding: 5px" align="center">
	Copyright © 2015-2018 俊博个人博客 版权所有
</div>
