...
<script type="text/javascript">
	...
	function openBlogTypeAddDialog(){
		...
		url="${pageContext.request.contextPath}/admin/admin/save.do";
	}
	...
	function openBlogTypeModifyDialog(){
		var selectedRows=$("#dg").datagrid("getSelections");
		 ...
		 $("#fm").form("load",row);
		 url="${pageContext.request.contextPath}/admin/admin/save.do?id="+row.id;
	 }
...
<table id="dg" title="管理员管理" class="easyui-datagrid"
   ...
   url="${pageContext.request.contextPath}/admin/admin/list.do" fit="true" toolbar="#tb">
   <thead>
   	<tr>
   		<th field="cb" checkbox="true" align="center"></th>
   		<th field="id" width="20" align="center">编号</th>
   		<th field="adminId" width="100" align="center">管理员名称</th>
   		<th field="adminPwd" width="100" align="center">管理员密码</th>
   	</tr>
   </thead>
 </table>
 <div id="tb">
 ...
 <div id="dlg" class="easyui-dialog" style="width:500px;height:180px;padding: 10px 20px"
   ...
   <form id="fm" method="post">
   	<table cellspacing="8px">
   		<tr>
   			<td>管理员名称：</td>
   			<td><input type="text" id="adminId" name="adminId" class="easyui-validatebox" required="true"/></td>
   		</tr>
   		<tr>
   			<td>管理员密码：</td>
   			<td><input type="text" id="adminPwd" name="adminPwd" class="easyui-validatebox" required="true" /></td>
   		</tr>
   	</table>
   </form>
 </div>
