	...
	<script type="text/javascript">
		...
		function deleteBlogType(){
			...
			$.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
				if(r){
					$.post("${pageContext.request.contextPath}/admin/admin/delete.do",{ids:ids},function(result){
						if(result.success){
							if(result.exist){
		...
		function openBlogTypeAddDialog(){
			...
			url="${pageContext.request.contextPath}/admin/teacher/save.do";
		}
		...
		function openBlogTypeModifyDialog(){
			...
			$("#fm").form("load",row);
			url="${pageContext.request.contextPath}/admin/teacher/save.do?id="+row.id;
		}
...
<table id="dg" title="教师管理" class="easyui-datagrid"
	   ...
	   url="${pageContext.request.contextPath}/admin/teacher/list.do" fit="true" toolbar="#tb">
	<thead>
	<tr>
		<th field="cb" checkbox="true" align="center"></th>
		<th field="id" width="20" align="center">编号</th>
		<th field="teaId" width="100" align="center">教师名称</th>
		<th field="teaPwd" width="100" align="center">教师密码</th>
	</tr>
	</thead>
</table>
<div id="tb">
...
<div id="dlg" class="easyui-dialog" style="width:500px;height:180px;padding: 10px 20px"
	...
	<form id="fm" method="post">
		<table cellspacing="8px">
			<tr>
				<td>教师名称：</td>
				<td><input type="text" id="teaId" name="teaId" class="easyui-validatebox" required="true"/></td>
			</tr>
			<tr>
				<td>教师密码：</td>
				<td><input type="text" id="teaPwd" name="teaPwd" class="easyui-validatebox" required="true" /></td>
			</tr>
			<tr>
				<td>教师密码：</td>
				<td>文件:<input type="file" name="file"/>
					<input name="uplodetime" type="hidden" id="nowDate"/>
